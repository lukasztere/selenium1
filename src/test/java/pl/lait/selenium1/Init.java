...
public class Init {
	...
	public static WebDriver getDriver() {  // // getDriver  - metoda z małej litery
		System.setProperty("webdriver.gecko.driver", "E:\\geckodriver\\geckodriver.exe"); //gdzie jest Firefox?
        ...
        driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS); // 30 sekund  konfigurujemy driver.manage czas czekania 30 s
